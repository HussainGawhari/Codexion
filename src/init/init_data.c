...
/*   Updated: 2026/08/17 18:46:20 by hgawhari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
    * This function prepares coders, dongles, mutex, and initialize values before thread starts.
    * log_mutex → prevents multiple threads from writing logs at the same time
    * simulation_mutex → protects the shared running state.
    * counter_mutex → protects request_counter when multiple coder threads create requests.
