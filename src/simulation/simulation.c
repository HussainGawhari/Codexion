...
/*   Updated: 2026/08/18 14:32:34 by hgawhari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	* Locks the mutex before reading data->running,
...
* pthread_cond_broadcast(&data->dongles[i].cond) wakes all threads
	waiting on that dongle's condition variable.
 ...
 * Creates a separate thread responsible for monitoring the simulation,
	especially burnout conditions
 ...
 * coder_routine,
	&data->coders[i-1] this is argument that passed to codeer_routine.
 */
